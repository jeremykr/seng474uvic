...
class House:
    ...
    def __init__(self):
        ...
        self.dict = dict([('Townhome', 0), ('Apartment', 1), ('Duplex', 2), ('Single Family', 3), ('Mobile Home', 4), ('Manufactured Home', 5), ('House', 6), ('Condo', 7), ('Townhouses', 8), ("Multi-Family", 9) ])
        self.regions = {"Victoria" : 0, "Vancouver" : 1}
